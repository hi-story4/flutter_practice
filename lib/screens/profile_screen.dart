...
import 'package:flutter_practice/components/bottom_icon_button.dart';
import 'package:flutter_practice/components/round_icon_button.dart';
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Colors.transparent,
          leading: IconButton(
            icon: Icon(FontAwesomeIcons.x, size: 30, color: Colors.white),
            onPressed: () {
